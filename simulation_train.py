...
if __name__ == "__main__":
    ...
    settings = {
        ...
        'model_saving':'model/simualtion_raondom.pkl',
        'result_saving':"simulation_result/loss_{}_rl_random025.txt",
        'batch_size': 1,
        'batch_size_real':1,
        'epoch_num': 100,
    ...
    settings2 = {
        ...
        'model_saving': 'model/simualtion_type.pkl',
        'result_saving': "simulation_result/loss_{}_rl_type.txt",
        'batch_size': 1,
        'batch_size_real': 1,
        'epoch_num': 100,
        'current_date': datetime.date.today(),
